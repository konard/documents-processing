...
async function resolveWard(page, applicant) {
  ...
  // of its own, and the site requires the field. Written "1 Sample Street,
  // Loc Tho Ward, Nha Trang" a booking says which; written "2 Example Road,
  // Nha Trang" it does not, and the field was left empty on a form that will
